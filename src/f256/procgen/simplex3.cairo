use cubit::f256::math::comp::{max, min};
use cubit::f256::types::fixed::{Fixed, FixedTrait, ONE_u256};
use cubit::f256::types::vec3::{Vec3, Vec3Trait};
use cubit::f256::types::vec4::{Vec4, Vec4Trait};
...
fn noise_octaves(v: Vec3, mut octaves: u256, persistence: Fixed) -> Fixed {
...
#[cfg(test)]
mod tests {
    use cubit::f256::procgen::simplex3;
    ...
    #[test]
    #[available_gas(100000000000)] // 342k steps
